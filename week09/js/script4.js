...
document.getElementById("calculate").addEventListener('click', findResult);

function findResult() {
    // Get the input string entered by the user from the input field
    let userInputStr = document.getElementById("numbers").value;
    /*
    Check if the input field left empty:
    */
    if (userInputStr == null || userInputStr == "") {
        document.getElementById("result").innerHTML = "Please, enter your numbers!"
    } else {
        ...
        // Test: Log the array of numbers for debugging purposes
